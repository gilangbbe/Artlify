...
| Item                                                                            | Status        | Notes                                                                              |
| ------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------- |
| **Branch `particles` — silhouette-as-swarm + trails + audio reactivity** | build green, untested on hardware | Dark bg, mask-attractive force, curl-noise drift, alpha gated by silhouette. Trail accumulator (ping-pong + decay) leaves fluid wakes. AudioReactor (AVAudioEngine + vDSP FFT, low/mid/high + level + pan + transient) modulates flow, glow, hue, and fires a stereo-panned shockwave on transients. New mic entitlement + Info.plist key. |
